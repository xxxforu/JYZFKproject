...
const handleExport =()=>{
 ...
 var exporSiteFile = function() {
    if(!value1.value[0] || !value1.value[1] ||!exportPid){
...
<template>
  ...
  <!--  某加油站页面-->
  <div v-else>
    <el-button class="exportData stasionExportData" @click="exportDataFormVisible = true" type="primary" size="large" round>导出Excel表格</el-button>
    <div  class="t_background">
      <div class="tmainBody">
        <el-table stripe :data="tableData" empty-text="暂无违规信息" :header-cell-style="{'text-align':'center'}" style="width: 100%">
          <el-table-column prop="time" label="时间" align="center" />
