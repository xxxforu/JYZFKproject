...
var tabOption = ref("SLData.vestibule")
var radio1 = ref()
const handleClick = (index, row) => {
  console.log(index, row,radio1.value)
}
</script>
      ...
      <el-tabs v-model="activeName" class="demo-tabs" @tab-click="handleClick">
        <div class="SLbox">
          <el-tab-pane label="前庭" name="vestibule">
            <el-table stripe :data="{{tabOption}}" style="width: 100%;height:100%">
                ...
                <el-table-column prop="checkTime4" label="4时" width="210">
                  <template #default="scope">
                    ...
                    <el-radio-group v-model="radio1" class="ml-4">
                      <el-radio label=1 @click="handleClick(scope.$index,scope.row)">Option 1</el-radio>
