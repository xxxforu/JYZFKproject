...
onMounted(()=>{
  if(sessionStorage.getItem('appealDate')) isAppeal.value = true
  var appealDate = ref(sessionStorage.getItem('appealDate') || "")
  var petrolName = ref(sessionStorage.getItem('petrolName') || "")
  var PN = ref(petrolName.value)
  console.log(petrolName.value);
  var description = ref(sessionStorage.getItem('description')||"")
