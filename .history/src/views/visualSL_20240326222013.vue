...
function init1() {
  ...
  var requesrURL = localStorage.getItem('role')==3?'/petrol/getPetrolItemException':localStorage.getItem('role')==2?'/branch/getItemException':'/central/getItemException'
...
function init2() {
  axios.get('/petrol/getPetrolOneItemContentException?item='+select.value+'&flag='+flag2.value).then(res=>{
    var data =  res.data.data
    console.log(SLData.value.data[select.value]);
  })
