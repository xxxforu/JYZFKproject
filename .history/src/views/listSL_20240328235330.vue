  ...
  axios.get('/branch/getSafeDailyList?companyId='+belong+'&date='+dateValue.value).then(res=>{
    ...
    if(res.data.data){
      for(let item in res.data.data){
        ...
        oneData.pid = item.pid
        oneData.itemDescribe = item.itemDescribe
    ...
    <div class="tmainBody">
      ...
      <el-table :data="tableData" style="width: 100%">
        ...
        <el-table-column label="巡检项目" align="center">
          <el-table-column prop="checkCount.vestibule" label="前庭不合格数"  width="80" align="center" :formatter="formatter1"  >
            <svg viewBox="0 0 80 80" width="15" height="15">
              <circle class="circle" cx="40" cy="40" r="38"/>
            </svg>
          </el-table-column>
          <el-table-column prop="itemDescribe.vestibule" label="前庭巡检描述"  width="130" align="center" :formatter="formatter1"  >
            <svg viewBox="0 0 80 80" width="15" height="15">
              <circle class="circle" cx="40" cy="40" r="38"/>
            </svg>
          </el-table-column>
          <el-table-column prop="checkCount.store" label="便利店" width="130" align="center" :formatter="formatter" >
            <svg viewBox="0 0 80 80" width="15" height="15">
              <circle class="circle" cx="40" cy="40" r="38"/>
            </svg>
          </el-table-column>
