...
const handleClick = (index, row) => {
  ...
  console.log(radioBox.value[tabName.vlaue][row.num]);
}

// 更换tabBar时触发，tabName即tabBar的英文名
const tabChange = (tabPaneName) =>{
 
  tabName.vlaue= tabPaneName
 console.log(radioBox.value[tabName.vlaue].description);
}
</script>
...
<template>
  <div id="block" >
    ...
    <div class="desciptBox">
      ...
      <p>加油站经理：<input type="text" v-model="radioBox[manager]"></p>
    </div>
    <div id="annouce">
