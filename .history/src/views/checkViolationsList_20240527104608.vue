...
<template>
  ...
  <div v-if="isCompany">
    <div id="topBox">
      <el-select v-model="value" filterable placeholder="搜索加油站" style="width: 240px" @change="changeCheckStation">
        <el-option class="select_item" v-for="item in options" :key="item.value" :label="item.label"
          :value="item.value" />
      </el-select>
      <el-button class="exportData" @click="exportDataFormVisible = true" type="primary" size="large"
    ...
    <div class="t_background">
      <div class="tmainBody">
        ...
        <el-row>
          <el-col style="">
            <el-pagination background hide-on-single-page layout="prev, pager, next" @current-change="handlePageChange"
              :total="lastPage" />
          </el-col>
        </el-row>
        <!-- 导出excel弹窗 -->
  ...
  <!--  某加油站页面-->
  <div v-else>
    <el-button class="exportData stasionExportData" @click="exportDataFormVisible = true" type="primary" size="large"
      round>导出Excel表格</el-button>
    <div class="t_background">
      <div class="tmainBody">
        <el-table stripe :data="tableData" empty-text="暂无违规信息" :header-cell-style="{ 'text-align': 'center' }"
        ...
        <el-row>
          <el-col style="">
            ...
            <!--            :total="1000"-->
            <!--        />-->
            <el-pagination hide-on-single-page background layout="prev, pager, next" @current-change="handlePageChange"
              :total="lastPage" />
          </el-col>
        </el-row>
      </div>
