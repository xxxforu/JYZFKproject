...
<template>
  <div class="bodyPagelSL" v-if="isCompany">
    ...
    <div class="tmainBody">
      <el-table :data="tableData" style="width: 100%">
        <el-table-column prop="pid" label="加油站编号" align="center" width="120" />
        <!--        <el-table-column prop="{{dateValue.value}}" label="时间" width="120"  />-->
        <el-table-column label="巡检项目" align="center">
          <el-table-column prop="contentChecking.1" label="前庭"  width="100" align="center" :formatter="formatter1"  >
            <svg viewBox="0 0 80 80" width="15" height="15">
              <circle class="circle" cx="40" cy="40" r="38"/>
            </svg>
          </el-table-column>
          <el-table-column prop="bian" label="便利店" width="100" align="center" :formatter="formatter" >
            <svg viewBox="0 0 80 80" width="15" height="15">
              <circle class="circle" cx="40" cy="40" r="38"/>
            </svg>
          </el-table-column>
          <el-table-column prop="you" label="油罐区" width="100" align="center" :formatter="formatter" >
            <svg viewBox="0 0 80 80" width="15" height="15">
              <circle class="circle" cx="40" cy="40" r="38"/>
            </svg>
          </el-table-column>
          <el-table-column prop="dian" label="电器设备" width="100" align="center" :formatter="formatter" >
            <svg viewBox="0 0 80 80" width="15" height="15">
              <circle class="circle" cx="40" cy="40" r="38"/>
            </svg>
          </el-table-column>
          <el-table-column prop="huan" label="环保" width="100" align="center" :formatter="formatter" >
            <svg viewBox="0 0 80 80" width="15" height="15">
              <circle class="circle" cx="40" cy="40" r="38"/>
            </svg>
          </el-table-column>
        </el-table-column>
        <el-table-column show-overflow-tooltip prop="checkStandard" label="巡检描述" width="400" />
  ...
  <div class="bodyPagelSL" v-else>
    ...
    <div class="tmainBody">
      <el-table :data="tableData" style="width: 100%;height:100%;" :header-cell-style="{fontSize: '14px', backgroundColor: '#fff',border: 'none !important'}">
