...
function goToFile(provePhoto){
  console.log(provePhoto);
        window.open(provePhoto,'_blank')
    }
  ...
  <div  class="t_background">
    <div class="tmainBody">
      <el-table :data="tableData" :header-cell-style="{'text-align':'center'}" style="width: 100%">
        ...
        <el-table-column label="申述附件" align="center" ><p id="link" @click="goToFile(provePhoto)">点击跳转查看附件</p></el-table-column>
        ...
        <!--            <template #header>-->
        <!--              &lt;!&ndash;              <el-input v-model="search" size="small" placeholder="Type to search" />&ndash;&gt;-->
        <!--            </template>-->
