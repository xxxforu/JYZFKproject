...
const toAnnounceBulletin =function(){
  console.log(radioBox.value.manager.length);
  //只判断有无经理名字
  if(radioBox.value.manager.length==0) ElMessage.error('请输入巡检经理名字！')
  var config = {
   method: 'post',
...
<template>
  <div id="block" >
    ...
    <div class="desciptBox">
      ...
      <p>巡检经理：<input type="text" v-model="radioBox[manager]"></p>
    </div>
    <div id="annouce">
