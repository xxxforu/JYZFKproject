...
console.log(row);
  ...
  sessionStorage.setItem('dateTime',row.date+" "+row.time)
...
function cList1(){
  axios.get('/central/getPetrolIllegalBehaviorList?page='+page.value+'&size=10').then(res=>{
    tableData.value = res.data.data.data
    lastPage.value=res.data.data.lastPage
    total.value=res.data.data.total
    for(let i=0;i<total.value;i++){
...
function  cList2(){
  axios.get('/branch/getPetrolIllegalBehaviorList?page='+page.value+'&size=10').then(res=>{
    tableData.value = res.data.data.data
    lastPage.value=res.data.data.lastPage
    total.value=res.data.data.total
    time.value = res.data.data.date+" "+res.data.data.time
