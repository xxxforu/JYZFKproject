...
<template>
  <div id="VDpage">
    ...
    <div class="topDetail">
      <p v-if="sessionStorage.getItem('appealDate')">申诉时间：{{sessionStorage.getItem('appealDate')}}</p>
      <p>违规时间：{{time}}</p>
    ...
    <div class="descript">
      <h2 v-if="sessionStorage.getItem('appealDate')" style="text-align: left;margin:10px 20px">申述内容</h2>
    ...
    <div class="toAppeal" v-if="sessionStorage.getItem('appealDate')">
