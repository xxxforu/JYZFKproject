                ...
                <el-table-column prop="checkTime4" label="4时" width="210">
                  <template #default="scope">
                    ...
                    <el-radio-group v-model="radio0" class="ml-4">
                      <el-radio label=1 @click="handleClick(scope.$index,scope.row)"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" data-v-ea893728=""><path fill="currentColor" d="M406.656 706.944 195.84 496.256a32 32 0 1 0-45.248 45.248l256 256 512-512a32 32 0 0 0-45.248-45.248L406.592 706.944z"></path></svg></el-radio>
                      <el-radio label=2 @click="handleClick(scope.$index,scope.row)">Option 2</el-radio>
                    </el-radio-group>
                  </div>
                  </template>
                </el-table-column>
