  ...
  <div class="bodyPagevSL">
    ...
    <div class="topBox" style="text-align: right; padding-left: 15px;padding-top: 10px;  margin-bottom: 20px">
      ...
      <span style="display: inline-block; height: 32px; ">
        <svg style="margin:auto"  width="20" height="20" class="DocSearch-Search-Icon" viewBox="0 0 20 20" size="14px"><path d="M14.386 14.386l4.0877 4.0877-4.0877-4.0877c-2.9418 2.9419-7.7115 2.9419-10.6533 0-2.9419-2.9418-2.9419-7.7115 0-10.6533 2.9418-2.9419 7.7115-2.9419 10.6533 0 2.9419 2.9418 2.9419 7.7115 0 10.6533z" stroke="currentColor" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round"></path></svg>
      </span>
    </div>
    <!-- <div>
