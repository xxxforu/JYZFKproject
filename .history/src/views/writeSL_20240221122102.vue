...
const handleClick = (index, row) => {
  console.log(index, row,radio0.value)
  fillDailyChecking[activeName.value][row.num] = []
  fillDailyChecking[activeName.value][row.num][0]=radio0.value
        ...
        <div class="SLbox">
          <el-tab-pane label="前庭" name="vestibule">
            <el-table stripe :data="SLData.vestibule" style="width: 100%;height:100%">
              ...
              <el-table-column show-overflow-tooltip prop="checkStandard" label="检查标准" width="200" />
              <el-table-column label="检查时间及结果">
                <el-table-column prop="checkTime4" label="4时" width="110">
                  <template #default="scope">
                    <div class="my-2 flex items-center text-sm" style="display:flex;">
                    <el-radio-group v-model="radio0" class="ml-4">
                      ...
                      <el-radio label=2 @click="handleClick(scope.$index,scope.row)"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" data-v-ea893728=""><path fill="currentColor" d="M764.288 214.592 512 466.88 259.712 214.592a31.936 31.936 0 0 0-45.12 45.12L466.752 512 214.528 764.224a31.936 31.936 0 1 0 45.12 45.184L512 557.184l252.288 252.288a31.936 31.936 0 0 0 45.12-45.12L557.12 512.064l252.288-252.352a31.936 31.936 0 1 0-45.12-45.184z"></path></svg></el-radio>
                    </el-radio-group>
                  </div>
                  </template>
                </el-table-column>
