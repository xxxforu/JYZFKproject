    ...
    series: [
      {
        ...
        radius: '50%',
        data: [
          {value: eInfo0.value.checking, name: '违规收费'},//=> value: checking
          {value: eInfo0.value.phone, name: '打手机'},//=> value: phone
          {value: eInfo0.value.work, name: '检修区不规范'},//=> value: work
          {value: eInfo0.value.hat, name: '未戴安全帽'},//=> value: hat
        ],
        //.value.map(d => d.value),
        emphasis: {
          itemStyle: {
