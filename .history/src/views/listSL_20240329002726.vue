    ...
    <div class="tmainBody">
      ...
      <el-table :data="tableData" style="width: 100%">
        ...
        <el-table-column label="巡检项目不合格数" align="center">
          <el-table-column prop="checkCount.vestibule" label="前庭不合格数" width="40" align="center" /> 

          <el-table-column prop="checkCount.store" label="便利店不合格数" width="40" align="center" />

          <el-table-column prop="checkCount.tankFarm" label="油罐区不合格数" width="40" align="center" />

          <el-table-column prop="checkCount.electric" label="电器设备不合格数" width="40" align="center" />
          
          <el-table-column prop="checkCount.environment" label="环保不合格数" width="40" align="center" />
        ...
        <el-table-column label="巡检项目简述" align="center">
          ...
          <el-table-column show-overflow-tooltip prop="itemDescribe.tankFarm" label="油罐区巡检描述"  width="130" align="center" />  

          <el-table-column show-overflow-tooltip prop="itemDescribe.electric" label="电器设备巡检描述"  width="130" align="center" /> 
          
          <el-table-column show-overflow-tooltip prop="itemDescribe.environment" label="环保巡检描述"  width="130" align="center" /> 
