...
<template>
  <div id="VDpage">
    ...
    <div class="descript">
      <h2 v-if="role==3" style="text-align: left;margin:10px 20px">申述内容</h2>
    ...
    <div class="toAppeal" v-if="role==3">
      <button @click="dialogVisible1 = true">我要申诉</button>
    </div>
  ...
  <div class="el-upload__text">
    ...
    <el-dialog v-model="dialogVisible1" title="处理申诉" width="500">
      ...
      <template #footer>
        <div class="dialog-footer">
          <el-button type="wrong" @click="noAgree">取消</el-button>
