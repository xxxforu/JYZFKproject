...
var onSubmit = () => {
  ...
  var config = {
    method: 'post',
    url: 'https://ps.gwcampus.cn/api/central/publishAnnouncement',
    headers: {
  ...
  <div v-loading="loading">
    ...
    <el-form :model="form" label-width="120px" :rules="rules">
      ...
      <el-form-item label="接收者">
        <div class="m-4">
          <el-cascader v-model="form.receiver" placeholder="选择接收者" :options="options" :props="props"
      ...
      <el-form-item>
        <el-upload class="upload-demo" action="#" ref="upload" :on-change="handleChange"
