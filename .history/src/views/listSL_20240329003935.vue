  ...
  axios.get('/branch/getSafeDailyList?companyId='+belong+'&date='+dateValue.value).then(res=>{
    ...
    if(res.data.data){
      ...
      for(let item in res.data.data){
        ...
        tableData.value.push(oneData)tableData.value.push(oneData)tableData.value.push(oneData)tableData.value.push(oneData)tableData.value.push(oneData)tableData.value.push(oneData)tableData.value.push(oneData)tableData.value.push(oneData)tableData.value.push(oneData)tableData.value.push(oneData)tableData.value.push(oneData)tableData.value.push(oneData)
      }
    }
...
<template>
  <div class="bodyPagelSL" >
    ...
    <div class="tmainBody">
      <!-- 表格 -->
      <el-table :data="tableData" style="width: 100%;max-height: 50vh;overflow-y: auto;">
