    ...
    <div class="tmainBody">
      ...
      <el-table :data="tableData" style="width: 100%">
        ...
        <el-table-column label="巡检项目简述" align="center">
          <el-table-column show-overflow-tooltip prop="itemDescribe.vestibule" label="前庭"  width="130" align="center" />  

          <el-table-column show-overflow-tooltip prop="itemDescribe.store" label="便利店"  width="130" align="center" />  

          <el-table-column show-overflow-tooltip prop="itemDescribe.tankFarm" label="油罐区"  width="130" align="center" />  

          <el-table-column show-overflow-tooltip prop="itemDescribe.electric" label="电器设备"  width="130" align="center" /> 
          
          <el-table-column show-overflow-tooltip prop="itemDescribe.environment" label="环保"  width="130" align="center" /> 
