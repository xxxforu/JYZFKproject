     ...
     series: [
       {
         ...
         radius: '50%',
         data: [
           {value: 168, name: '违规收费'},//=> value: checking
           {value: 293, name: '打手机'},//=> value: phone
           {value: 201, name: '检修区不规范'},//=> value: work
           {value: 79, name: '未戴安全帽'},//=> value: hat
         ],
         //.value.map(d => d.value),
         emphasis: {
           itemStyle: {
...
// const data1 = ref([
//   {value: 168, name: '违规收费'},//=> value: checking
//   {value: 293, name: '2月'},//=> value: phone
//   {value: 201, name: '3月'},//=> value: work
    ...
    <div>
      ...
      <div class="box">
        <div style="float: right ; margin-right: 20px; margin-top: 10px">
          <el-radio-group v-model="radio1" @click="clickTest" >
            <el-radio-button label="1">当天</el-radio-button>
            <el-radio-button label="0">近七天</el-radio-button>
          </el-radio-group>
        </div>
